...
const addDoctor = async (req, res) => {
    try {
        ...
        if (!validator.isEmail(email)) {
            return res.json({ success: false, message: "Incorrect Email,Please enter a valid email!!!" })
        }
        ...
        res.json({ success: true, message: "Doctor Details are Added" })
    ...
    // API to get dashborad dara for admin panel
