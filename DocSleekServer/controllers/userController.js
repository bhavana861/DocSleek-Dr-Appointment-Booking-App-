...
const registerUser = async (req, res) => {
    try {
        ...
        if (!name || !email || !password) {
            return res.json({ success: false, message: "Missing Some Fileds" })
        }
...
export { registerUser, loginUser, getProfile, editProfile, bookAppointment, listAppointment, cancelAppointment ,paymentRazorpay,verifyRazorpay}